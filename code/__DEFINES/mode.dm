...
GLOBAL_LIST_INIT(ROLES_AI_MOVIE, list(JOB_SO, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE, JOB_ADVISOR, JOB_CORPORATE_LIAISON, JOB_DROPSHIP_PILOT, JOB_DROPSHIP_CREW_CHIEF))
